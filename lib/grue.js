...
GrueParser.prototype = {
    onStartDocument: function() {
        console.log("onStartDocument: %s", arguments);
    },
    onEndDocument: function() {
        console.log("onEndDocument: %s", arguments);
    },
    onStartElementNS: function(name, attrs, prefix, nsuri, ns) {
        console.log("onStartElementNS: %s", arguments);
    },
    onEndElementNS; function(name, prefix, nsuri) {
        console.log("onEndElementNS: %s", arguments);
    },
    onCharacters: function(text) {
        console.log("onCharacters: %s", arguments);
    },
    processingInstruction: function(name, text) {
        console.log("processingInstruction: %s", arguments);
    },
    onCdata: function(text) {
        console.log("onCdata: %s", arguments);
    },
    onComment: function(text) {
        console.log("onComment: %s", arguments);
    },
    onError: function(msg) {
        console.log("onError: %s", arguments);
    },
};